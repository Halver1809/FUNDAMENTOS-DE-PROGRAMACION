#TRABAJO FUNDAMENTOS DE PROGRAMACION 


#implementamos la función pi de math para poder crear ciertas operaciones.
from math import pi



while True:
#creamos un ciclo mostrando las 4 opciones principales para que el usuario elija la respectiva.
    print ("MENU. \n1.Operadores. \n2.Condicionales. \n3. ciclos \n4.salir. (marque el número (99) si desea salir del programa.) ")
    menu = int(input("Digite la operacion que desea realizar: "))
    if menu == 1:
        # se genera un submenu con las opciones de operadores para que el usuario elija.
        ...
        while True:
            ...
            operadores = int(input("Digite la operación que desea usar: "))
            while operadores == 1:
                ...
                eleccion = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion == 1:
                    break
            ...
            while operadores == 2:
                ...
                eleccion1 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion1 == 1:
                    break
            while operadores == 3:
                ...
                eleccion2 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion2 == 1:
                    break
            while operadores == 4:
                ...
                eleccion3 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion3 == 1:
                    break 
            while operadores == 5:
                ...
                eleccion4 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion4 == 1:
                    break
            ...
            while operadores == 6:
                ...
                eleccion5 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion5 == 1:
                    break
            ...
            while operadores == 7:
                ...
                eleccion6 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion6 == 1:
                    break
            while operadores == 8:
                ...
                eleccion7 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion7 == 1:
                    break
        ...
        while True:
            ...
            while condicionales ==1:
                ...
                eleccion_1 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_1 == 1:
                        break
            ...
            while condicionales ==2:
                ...
                eleccion_2 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_2 == 1:
                    break
            ...
            while condicionales == 3:
                ...
                eleccion_3 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_3 == 1:
                    break
            ...
            while condicionales == 4:
                ...
                eleccion_4 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_4 == 1:
                    break
            ...
            while condicionales == 5:
                ...
                eleccion_5 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_5 == 1:
                    break
            ...
            while condicionales == 6:
                ...
                eleccion_6 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_6 == 1:
                    break
            ...
            while condicionales == 7:
                ...
                eleccion_7 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion_7 == 1:
                    break
        ...
        while True:
            ...
            while ciclos == 1:
                ...
                print (multiplos)
                eleccion__1 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__1 == 1:
                    break
            while ciclos == 2:
                ...
                print (impares)
                eleccion__2 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__2 == 1:
                    break
            ...
            while ciclos == 3:
                ...
                print(pares)
                eleccion__3 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__3 == 1: 
                    break
            while ciclos == 4:
                ...
                print (cuadrado)
                eleccion__4 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__4 == 1:
                    break
            while ciclos == 5:
                ...
                eleccion__5 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__5 == 1:
                    break
            ...
            while ciclos == 6:
                ...
                eleccion__6 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__6 == 1:
                    break
            while ciclos == 7:
                ...
                eleccion__7 = int(input("elija  '1' si desea salir o elija cualquier otro numero diferente a 1 si desea volver a usar la opcion: "))
                if eleccion__7 == 1:
                    break
